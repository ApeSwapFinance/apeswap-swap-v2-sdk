import { Network } from './networkBalancer';
...
export const BALANCER_NETWORK_CONFIG: Record<Network, BalancerNetworkConfig> = {
  ...
  [Network.POLYGON]: {
    chainId: Network.POLYGON as any, //137
    addresses: {
      contracts: {
        vault: '0xBA12222222228d8Ba445958a75a0704d566BF2C8',
  ...
  [Network.ARBITRUM]: {
    chainId: Network.ARBITRUM as any, //42161
    addresses: {
      contracts: {
        vault: '0xBA12222222228d8Ba445958a75a0704d566BF2C8',
  ...
  [Network.KOVAN]: {
    chainId: Network.KOVAN as any, //42
    addresses: {
      contracts: {
        vault: '0xBA12222222228d8Ba445958a75a0704d566BF2C8',
  ...
  [Network.ROPSTEN]: {
    chainId: Network.ROPSTEN as any, //3
    addresses: {
      contracts: {
        vault: '0xBA12222222228d8Ba445958a75a0704d566BF2C8',
  ...
  [Network.RINKEBY]: {
    chainId: Network.RINKEBY as any, //4
    addresses: {
      contracts: {
        vault: '0xBA12222222228d8Ba445958a75a0704d566BF2C8',
  ...
  [Network.GOERLI]: {
    chainId: Network.GOERLI as any, //5
    addresses: {
      contracts: {
        vault: '0xBA12222222228d8Ba445958a75a0704d566BF2C8',
